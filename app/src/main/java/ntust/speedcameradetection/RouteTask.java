...
public class RouteTask {
    ...
    private final static int ROUTE_LINE_WIDTH = 10;
    private final static int ROUTE_LINE_COLOR = Color.RED;
    GoogleMap map;

    public RouteTask(GoogleMap map) {
        this.map = map;
    }

    public void execute(LatLng start, LatLng end) {
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String,String>>> >{
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            if (lineOptions != null) {
                ...
                Log.e(TAG, "lineOptions result == null");
            }
        }
    }
}
